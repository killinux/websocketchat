...
<div class="col-xs-12" style="padding-bottom:8px;">  
	<a href="#"> 
		...
		<div class="col-xs-10">
			...
			<span class="pull-right" style="padding-top:5px; color:#CCCCCC; font-size:12px"><!--早上11:56--></span>
			<br>
			<div style="width:100%;padding-top:10px; color:#999999; padding-left:5px; font-size:14px" class="text-left"><input type="text" id="user_password" />
				<span class="pull-right">&nbsp;</span>
			</div>	
		</div>
	</a>
...
<div class="col-xs-12" style="padding-bottom:8px;">  
	<a href="#"> 
		...
		<div class="col-xs-10">
			...
			<span class="pull-right" style="padding-top:5px; color:#CCCCCC; font-size:12px"><!--早上11:56--></span>
			<br>
			<div style="width:100%;padding-top:10px; color:#999999; padding-left:5px; font-size:14px" class="text-left"><input type="button" onclick="mytest();"  value="注册"/>&nbsp;&nbsp;&nbsp;&nbsp;<a href="login.jsp" >去登陆</a>
				<span class="pull-right">&nbsp;</span>
			</div>	
		</div>
	</a>
