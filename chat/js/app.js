...
var App = function() {
    ...
    o = function() {
        ...
        var e = $("#year-copy"),
        a = new Date;
        2014 === a.getFullYear() ? e.html("2014") : e.html("2014-" + a.getFullYear().toString().substr(2, 2)),
    ...
    n = function() {
        ...
        a.click(function() {
            var a = $(this);
            return a.parent().hasClass("active") !== !0 && (a.hasClass("open") ? a.removeClass("open").next().slideUp(e) : ($(".sidebar-nav-menu.open").removeClass("open").next().slideUp(e), a.addClass("open").next().slideDown(t))),
            !1
        }),
        i.click(function() {
            var a = $(this);
            return a.parent().hasClass("active") !== !0 && (a.hasClass("open") ? a.removeClass("open").next().slideUp(e) : (a.closest("ul").find(".sidebar-nav-submenu.open").removeClass("open").next().slideUp(e), a.addClass("open").next().slideDown(t))),
            !1
        })
    },
    l = function(o) {
    ...
    h = function() {
        ...
        s = $("#theme-link");
        s.length && (a = s.attr("href"), $("li", i).removeClass("active"), $('a[data-theme="' + a + '"]', i).parent("li").addClass("active")),
        $("a", i).click(function() {
            a = $(this).data("theme"),
            $("li", i).removeClass("active"),
            $(this).parent("li").addClass("active"),
            "default" === a ? s.length && (s.remove(), s = $("#theme-link")) : s.length ? s.attr("href", a) : ($('link[href="css/themes.css"]').before('<link id="theme-link" rel="stylesheet" href="' + a + '">'), s = $("#theme-link"))
        }),
        ...
        e.hasClass("style-alt") ? n.addClass("active") : o.addClass("active"),
        o.click(function() {
        ...
        t.hasClass("navbar-default") ? r.addClass("active") : d.addClass("active"),
        t.hasClass("navbar-fixed-top") ? c.addClass("active") : t.hasClass("navbar-fixed-bottom") && h.addClass("active"),
        r.click(function() {
            t.removeClass("navbar-inverse").addClass("navbar-default"),
            $(this).addClass("active"),
            d.removeClass("active")
        }),
        d.click(function() {
            t.removeClass("navbar-default").addClass("navbar-inverse"),
            $(this).addClass("active"),
